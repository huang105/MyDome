...
import baseus.OtherAdapter;
import bean.MyGridView;

public class PindaoActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public void initView() {
       ...
       // mUserGv.setOnItemClickListener(this);
        mUserGv.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View view) {
                Toast.makeText(PindaoActivity.this, "dainji", Toast.LENGTH_SHORT).show();
